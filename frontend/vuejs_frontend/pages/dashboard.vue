          ...
          <card type="default" header-classes="bg-transparent">
            <div slot="header" class="row align-items-center">
              <div class="col">
                ...
                <h5 class="h3 text-white mb-0">CPU</h5>
              </div>
              <div class="col">
            ...
            <!--              :extra-options="bigLineChart['chartOption']"-->
            <!--            >-->
            <!--            </line-chart>-->
            <c-p-u-chart :data="ram" :height="350" :width="800"/>
...
export default {
  ...
  methods: {
    ...
    initBigChart(index) {
      ...
      this.bigLineChart.chartData = this.chartData.datasets;
      this.bigLineChart.chartOption = chartOption;
    }
  },
};
</script>
